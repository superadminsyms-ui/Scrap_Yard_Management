    ...
    return (
      <div className="w-full">
        ...
        <select
          ...
          id={selectId}
          className={cn(
            'w-full rounded-lg border bg-surface px-4 py-2.5 text-body-md text-secondary-800 transition-all duration-200 ease-emphasized focus:outline-none focus:ring-2 focus:ring-offset-0',
            error
